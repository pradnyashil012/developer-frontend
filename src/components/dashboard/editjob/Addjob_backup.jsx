...
const Addjob = (theme) => {
    ...
    return (
      ...
      <button href='jobform' onClick={handleBtn2Toggle} className={`border-2 w-[12rem] mr-4 border-[#003979] text-[#003979]  font-semibold rounded-full px-12 py-2 mt-7 inline-block ${btnState === 2 && "bg-[#003979] text-white" } hover:bg-[#003979] hover:text-white`}>Add Job</button>
      <button href='internshipform' onClick={handleBtn1Toggle} className={`border-2 border-[#003979] text-[#003979] font-semibold rounded-full px-12 py-2 mt-7 inline-block ${btnState === 1 && "bg-[#003979] text-white" } hover:bg-[#003979] hover:text-white`}>Add Internship</button>
      </div>

      {btnState === 2 && <Jobform />  }
      {btnState === 1 && <Internshipform />}
